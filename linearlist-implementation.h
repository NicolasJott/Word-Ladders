...
template <typename ListType>
int LinearList<ListType>::size() { return count; }
...
template <typename ListType>
int LinearList<ListType>::search(const ListType& key) {
    ListNode<ListType>
...
template <typename ListType>
void LinearList<ListType>::insert(int pos, const ListType& d) {
    ListNode<ListType>
            * ptr,
            ** pred;
...
template <typename ListType>
void LinearList<ListType>::remove(int pos) {
    ListNode<ListType>
            * ptr,
            ** pred;
